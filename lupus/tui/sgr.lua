...
local function apply_code(st, code)
  ...
  elseif code == 1 then st.bold = true
  elseif code == 2 then st.dim = true
  elseif code == 3 then st.italic = true
  elseif code == 4 then st.underline = true
  elseif code == 7 then st.reverse = true
  elseif code == 22 then st.bold, st.dim = nil, nil
  elseif code == 23 then st.italic = nil
  elseif code == 24 then st.underline = nil
  elseif code == 27 then st.reverse = nil
  elseif code >= 30 and code <= 37 then st.fg = code - 30
  elseif code == 39 then st.fg = nil
  elseif code >= 90 and code <= 97 then st.fg = code - 90 + 8
  end
